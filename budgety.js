var budgetController = (function() {
    ...
    return {
        ...
        calculateBudget: function() {
            ...
            //calculate the budegt: income-expense
...
var UIController = (function() {
    ...
    var DOMStrings = {
        inputType: '.add__type',
        inputDescription: '.add__desscription',
    ...
    var formatNumber = function(num, type) {
        ...
        */
        ...
        else if (int.length > 3 && int.length < 6) {
    ...
    return {
        ...
        addListItem: function(obj, type) {
            ...
            //Replace theplaceholder text with actual data
        ...
        //In Javascript you can only delete the child element.
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var updatePercentages = function() {
        ...
        //3.Update the UI with new percenatges
